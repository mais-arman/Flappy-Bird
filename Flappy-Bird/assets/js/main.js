...
hole.addEventListener("animationiteration", () => {
  let rand = Math.random() * (500 - 150); //container game height: 500px   hole height: 150px;
...
setInterval(function () {
  ...
  // Game Over
  if (
    birdTop > 480 || // تخطى الحاجز الي تحت
    (obstacleLeft < 20 && (birdTop > holeTop + 150 || birdTop < holeTop))
  )//obstacleLeft < 20 .. وصل عند العصفور لانه عرضه كان 20
  {
